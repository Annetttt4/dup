...
<?php $this->beginBody() ?>
    ...
    <section class="section section-top section-full">
        ...
        <!-- Cover -->
        <div class="bg-cover" style="background-image: url(/web/img/56.jpg);"></div>
    ...
    <section class="section bg-light" id="about">
        <div class="container">
            <div class="row ">
                <div class="col-lg-6">
                    <div class="about-img">
                        <img src="/web/img/about/56.jpg" alt="" class="img-fluid">
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-6 mb-5">
                    <div class="portfolio-block">
                        <img src="/web/img/portfolio/43.png" alt="portfolio">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-5">
                    <div class="portfolio-block">
                        <img src="/web/img/portfolio/44.png" alt="portfolio">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="portfolio-block">
                        <img src="/web/img/portfolio/45.png" alt="portfolio">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="portfolio-block">
                        <img src="/web/img/portfolio/46.png" alt="portfolio">
                           ...
                           <div class="col-lg-8 m-auto">
                            <div class="carousel-item active text-center test-content">
                                <div class="client-img">
                                    <img src="/web/img/review/tes-1.jpg" alt="" class="img-fluid ">
                                </div>
                             ...
                             <div class="carousel-item text-center test-content">
                                <div class="client-img">
                                    <img src="/web/img/review/tes-2.jpg" alt="" class="img-fluid ">
                                </div>
                              ...
                              <div class="carousel-item text-center test-content">
                                ...
                                <div class="client-img">
                                    <img src="/web/img/review/tes-3.jpg" alt="" class="img-fluid ">
                                </div>
